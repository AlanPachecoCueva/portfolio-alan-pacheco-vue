...
<template>
  <div class="admin-page">
    ...
    <div class="admin-content">
      ...
      <form class="achievement-form" @submit.prevent="handleSave">
        <section class="form-section">
          ...
          <div class="field-row">
            ...
            <div class="field"><label>Institución / Emisor *</label><input v-model="form.issuer" required placeholder="UDLA, Ingennials..." /></div>
            <div class="field"><label>Fecha</label><input v-model="form.dateStr" type="date" /></div>
          </div>
          <div class="field"><label>URL del certificado (opcional)</label><input v-model="form.link" type="url" placeholder="https://..." /></div>
        </section>

        <section class="form-section">
          <h2 class="section-title">Descripción</h2>
          <div class="field"><label>Descripción en español *</label><textarea v-model="form.description_es" required rows="3" placeholder="Describe el logro en español..." /></div>
          <div class="field"><label>Descripción en inglés *</label><textarea v-model="form.description_en" required rows="3" placeholder="Describe the achievement in English..." /></div>
        </section>
        ...
        <div class="form-actions">
          <button type="submit" class="btn-primary" :disabled="saving">{{ saving ? 'Guardando...' : 'Crear logro' }}</button>
...
import { createAchievement } from '~/utils/firebase/achievements.js'
import { Timestamp } from 'firebase/firestore'

export default {
  name: 'Admin_AchievementNew',
