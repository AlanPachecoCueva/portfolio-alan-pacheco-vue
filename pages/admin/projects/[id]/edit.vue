...
import { getProject, updateProject } from '~/utils/firebase/projects.js'
import { Timestamp } from 'firebase/firestore'

export default {
  name: 'Admin_ProjectEdit',
  ...
  async mounted() {
    ...
    if (project) {
      ...
      this.form = { ...this.form, ...project, dateStr: date.toISOString().split('T')[0], order: project.order ?? null, url: project.url ?? '', imageUrls: project.imageUrls || [], relatedTechnologies: project.relatedTechnologies || [] }
    }
